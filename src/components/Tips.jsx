...
const Tips = () => {
    ...
    return (
        <div className='my-10 w-11/12 mx-auto'>
            <h1 data-aos='fade-right' className='text-center font-bold text-2xl'>Winter Care Tips for <span className='text-green-700'>Pets</span></h1>
            <div className='my-8 grid md:grid-cols-2 lg:grid-cols-4'>
                <div data-aos='fade-right' className='border border-black/10 p-4 space-y-2 bg-white'>
                ...
                <div data-aos='fade-left' className='border border-black/10 p-4 space-y-2 bg-white'>
